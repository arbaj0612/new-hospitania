															...
															<tr>
																...
																<td>
																	<div className="product-name">
																		...
																		<p className="cart-item move-to-top my-0"><small>250g</small></p>
																		<p className="text-adjust"><b>₹60</b> <del>₹120</del> <small className="text-color-green">(50.00% OFF)</small></p>
																		<div className="prdct-remove-btn">
